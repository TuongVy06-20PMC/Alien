                                  ...
                                  Container(
                                          ...
                                          Padding(
                                            ...
                                            child: ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                backgroundColor:
                                                function_5050?
                                                    HexColor('FF0000'): HexColor('FF0000').withOpacity(0.5),
                                      ...
                                      width: 2, color: Colors.black),*/
                                          ...
                                          Padding(
                                            ...
                                            child: ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                backgroundColor: function_x2?
                                                    HexColor('FF0075'):HexColor('FF0075').withOpacity(0.5),
                                                minimumSize: Size(80, 80),
                                                /*side: const BorderSide(
                                      width: 2, color: Colors.black),*/
                                              ),
                                          ...
                                          Padding(
                                            ...
                                            child: ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                backgroundColor:function_skip?
                                                    HexColor('3EC70B'): HexColor('3EC70B').withOpacity(0.5),
                                                minimumSize: Size(80, 80),
                                                /*side: const BorderSide(
                                      width: 2, color: Colors.black),*/
                                              ),
